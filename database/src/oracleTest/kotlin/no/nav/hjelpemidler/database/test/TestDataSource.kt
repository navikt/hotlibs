            ...
            tx.execute(
                ...
                """
                    ...
                    (
                        ...
                        "LONG"                  NUMBER(19)                  DEFAULT 20       NOT NULL,
                        string                  VARCHAR2(255)               DEFAULT 'string' NOT NULL,
                        enum                    VARCHAR2(255)               DEFAULT 'A'      NOT NULL,
                        data_required           CLOB                        DEFAULT '{}'     NOT NULL,
                        data_optional           CLOB,
                        fnr                     CHAR(11),
                        aktor_id                CHAR(13)                    DEFAULT '1234567891011',
                        boolean_required        boolean                     DEFAULT 0        NOT NULL,
