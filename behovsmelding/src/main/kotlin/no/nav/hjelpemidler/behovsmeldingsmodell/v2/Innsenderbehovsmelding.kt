...
enum class VedleggType {
    ...
    STELLEBORD_VEGGMONTERT_MÅLSATT_TEGNING,
    STELLEBORD_VEGGMONTERT_GODKJENNING_MONTERING,
    KROPPSTØRKER_GODKJENNING_MONTERING
}
...
enum class ProduktkategoriType {
    LYDOVERFØRINGSANLEGG, DØRAUTOMATIKK, STELLEBORD_VEGGMONTERT, KROPPSTØRKER
}
