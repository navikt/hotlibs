...
fun <T> treeToValue(node: JsonNode, type: TypeReference<T>): T =
    jsonMapper.treeToValue<T>(node, type)
...
fun <T> jsonToValue(@Language("JSON") value: String, type: TypeReference<T>): T =
    jsonMapper.readValue<T>(value, type)
